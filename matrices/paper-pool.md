...
| P45 | Code-specific LLMs survey | Low | First pass completed; needs PDF-level verification | Code LLM evolution; code-task benchmarks; broad code-specific LLM background |

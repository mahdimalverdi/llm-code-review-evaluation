...
| ----------------------------------- | ------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- | ------------------------------------------------------------- |
| Technical correctness               | Is the comment technically true?                                                | Human labels, issue coverage, code resolution, factuality judge                         | P01, P02, P03, P04, P05, P06, P54, P58, P69, P106, P111, P121 |
...
| Grounding / context alignment       | Can the comment’s claims be traced to provided context?                        | Claim-to-diff grounding, hallucination labels, grounded rationale                       | P02, P03, P40, P41, P107, P109, P111, P121                    |
...
| Actionability                       | Can the developer act on the comment?                                           | Actionability gate, human labels, accepted comments, actionable explanation             | P01, P03, P07, P39, P41, P113, P118, P123                     |
...
| Explanation / rationale quality     | Does the comment explain why the issue matters?                                 | Explanation clarity, rationale grounding, explanation usefulness                        | P25, P41, P113, P118, P123                                    |
...
| Issue/review coverage               | How many relevant issues are found?                                             | Recall-like issue coverage, missed human-flagged issues                                 | P04, P05, P06, P37, P38, P107, P109, P111, P121               |
...
| Reviewer time overhead              | How much extra human time does the comment require?                             | Inspection/editing time, median overhead, reviewability cost                            | P07, P37, P38, P40, P110, P115                                |
| Computational cost                  | What is the inference/judging cost?                                             | Token cost, API cost, model-call count                                                  | P01, P02                                                      |
| Latency                             | How much delay does the method introduce?                                       | Inference time, reviewer wait time, pipeline delay                                      | P01, P02, P07, P37, P38, P109, P111, P119                     |
| Operational complexity              | How hard is it to deploy and maintain?                                          | Workflow integration, quality gates, monitoring                                         | P03, P07, P37                                                 |
| Developer trust                     | Does the system increase or erode trust?                                        | Survey, adoption, feedback, acceptance patterns, rationale quality                      | P03, P07, P37, P41, P110, P115                                |
...
| Evaluator robustness                | Is the instrument stable under order, prompt, source, or adversarial variation? | Human agreement, swaps, perturbations, repeated runs, attack tests                      | P29–P36, P63, P64, P67, P68, P112, P116, P121                |

## Additional evidence from the completed provisional batch

The completed P100–P123 extraction adds several cross-study constraints. P107 and P109 show that tool grounding and defect-focused metrics should report both coverage and false alarms. P112 demonstrates that repeatability is not guaranteed by temperature zero, so test–retest reliability belongs beside correctness. P115 shows that providing automated review output can anchor human reviewers without improving high-severity issue detection or saving time. P116 and P113 reinforce that reference overlap is not an adequate proxy for review quality: reference-free relevance, issue localization, explanation, and applicability should be separated. P118 and P123 further show that provenance-aware examples and reviewer-experience signals can improve explanation and actionability, but may encode local norms or lexical-retrieval bias. P120 and P122 support reporting data availability, prompt context, and repair validation as explicit deployment conditions.
